...
export function SelectContent({ children, className = '' }: SelectContentProps) {
  ...
  return (
    <div className={`absolute z-50 min-w-[8rem] overflow-hidden rounded-md border border-border bg-popover text-popover-foreground shadow-md animate-in fade-in-80 ${className}`}>
      <div className="p-1">
        {children}
      </div>
    </div>
