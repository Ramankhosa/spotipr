...
type Client = {
  ...
  rateLimitPerMinute: number; dailyRequestLimit: number; monthlyRequestLimit: number; dailyAnalysisLimit: number; createdAt: string; lastRequestAt?: string | null
  keys: ApiKey[]; usage: { minute: number; day: number; month: number; analysisDay: number }; requestLogs?: RequestLog[]
}
type Readiness = {
