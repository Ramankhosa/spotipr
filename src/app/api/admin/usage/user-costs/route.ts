...
export async function GET(request: NextRequest) {
  try {
    ...
    // Calculate totals
    const totals = userCosts.reduce((acc, u) => ({
      totalInputTokens: acc.totalInputTokens + u.totalInputTokens,
      totalOutputTokens: acc.totalOutputTokens + u.totalOutputTokens,
