...
export const MINER_PROPOSE_STAGE_CODE = 'MINER_PROPOSE'
export const MINER_RETRIEVAL_PLAN_STAGE_CODE = 'MINER_RETRIEVAL_PLAN'
export const MINER_EVIDENCE_MAP_STAGE_CODE = 'MINER_EVIDENCE_MAP'
