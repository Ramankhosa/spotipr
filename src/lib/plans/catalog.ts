...
export const FEATURE_DEFINITIONS: FeatureDefinition[] = [
  ...
  {
    code: 'WHITESPACE_ANALYSIS',
    name: 'Whitespace Studio',
    unit: 'analyses',
    description:
...
export const TASK_LABELS: Record<TaskCode, string> = {
  ...
  WS_SCOPE: 'Whitespace: Scope Compile',
  WS_CLUSTER_LABEL: 'Whitespace: Cluster Labelling',
  WS_CLAIM_ELEMENTS: 'Whitespace: Claim-Element Extraction',
