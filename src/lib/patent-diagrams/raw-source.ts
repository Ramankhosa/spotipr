  ...
  const [diagramSource] = await prisma.$transaction([
    prisma.diagramSource.upsert({
      ...
      create: {
        ...
        sourceMode: 'RAW_OVERRIDE', labelMap: validation.facts.labelMap, renderArtifacts: renderArtifacts as any, renderStatus: 'SUCCESS', renderError: null,
      ...
      update: {
        ...
        renderArtifacts: renderArtifacts as any, renderStatus: 'SUCCESS', renderError: null, semanticChecksum: null, referenceMapChecksum,
